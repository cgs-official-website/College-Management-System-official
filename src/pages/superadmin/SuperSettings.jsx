    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex flex-col lg:flex-row gap-8 mt-8">
        ...
        <div className="w-full lg:w-64 shrink-0">
          <div className="bg-white dark:bg-[#0A0F1C] border border-slate-200 dark:border-white/10 rounded-2xl p-2 shadow-sm flex flex-row lg:flex-col overflow-x-auto lg:overflow-visible">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-medium whitespace-nowrap text-left ${
                    isActive 
