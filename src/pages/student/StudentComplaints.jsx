...
const StudentComplaints = () => {
  ...
  const handleSubmitComplaint = (e) => {
    e.preventDefault();
    toast.success('Your complaint has been submitted. You will be notified when it is resolved.');
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Raise a grievance and track its resolution status.</p>
        </div>
        <button
      ...
      {/* Stats - Student only sees their own */}
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center p-6">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm max-w-sm">You haven't filed any complaints yet. Use the "Raise Complaint" button to report an issue.</p>
        </div>
      </motion.div>
            ...
            >
              ...
              <form onSubmit={handleSubmitComplaint} className="p-6 space-y-4">
                <div>
                  ...
                  <input type="text" placeholder="Brief title of your complaint" className="w-full px-4 py-2 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all dark:text-white" required />
                </div>
                ...
                <div>
                  ...
                  <textarea rows="4" placeholder="Describe the issue in detail..." className="w-full px-4 py-2 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all dark:text-white resize-none" required></textarea>
                </div>
