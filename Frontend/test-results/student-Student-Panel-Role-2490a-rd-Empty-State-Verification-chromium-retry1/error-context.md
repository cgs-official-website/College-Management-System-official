...
- Name: student.spec.js >> Student Panel Role-Based Verification >> TC-029a: Campus Store - Dashboard Empty State Verification
- Location: tests\student.spec.js:150:3

# Error details

```
Error: Authentication failed for Student with error: "Too many failed attempts. Please try again later.". Please configure valid credentials in tests/testData.js.
```
