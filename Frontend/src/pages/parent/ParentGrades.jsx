    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Review examination results, assignment scores, and overall performance.</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-[#0A0F1C] border border-slate-200 dark:border-white/10 rounded-3xl p-12 text-center mt-6">
        ...
        <p className="text-slate-500">There are currently no academic records or exam results published for this semester.</p>
      </div>
    </div>
  );
}
