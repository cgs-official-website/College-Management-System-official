...
export default function StaffOverviewChart({ deptData }) {
  ...
  return (
    <div className="h-72 w-full">
      <h3 className="text-sm font-semibold text-center mb-2 text-slate-500 dark:text-slate-400">Staff per Department</h3>
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={deptData} layout="vertical" margin={{ top: 5, right: 30, left: 10, bottom: 5 }}>
          ...
          <YAxis dataKey="name" type="category" fontSize={12} tickLine={false} axisLine={false} stroke="#6b7280" width={100} />
