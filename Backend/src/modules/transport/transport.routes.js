...
import { getItems, createItem, deleteItem, bulkImportVehicles } from './transport.controller.js';
...
router.post('/bulk', requirePermission('transport', 'create'), catchAsync(bulkImportVehicles));
